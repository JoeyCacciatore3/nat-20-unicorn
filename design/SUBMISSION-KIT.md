...
Copy is paste-ready. **All facts re-verified against `src/*.js` 2026-09-12 at B41 (staged working tree: AI role separation + opening tutorial + seed corrections; built 12,873 B, pending ship).**
