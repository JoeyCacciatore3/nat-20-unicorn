...
> **Ground-truth note:** last full audit 2026-09-07 (batch 9). If any figure here disagrees with `src/data.js` + `src/main.js` + `src/world.js`, the source wins — re-grep before trusting.
...
│                              and white HUD text (batch 8 recolored to #8cf). RE-SHOOT against batch-9 build before final submission.
